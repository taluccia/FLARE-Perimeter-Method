...
st_write(dnbr_at, "../outputs/clean-shapefile/AK_dnbr_fire_2004.shp", driver="ESRI Shapefile") 
st_write(rdnbr_at, "../outputs/clean-shapefile/AK_rdnbr_fire_2004.shp", driver="ESRI Shapefile")  
```
